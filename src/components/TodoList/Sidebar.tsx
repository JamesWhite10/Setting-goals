...
const Sidebar: React.FC = () => {
  return (
    <div className={"flex position-relative h-screen opacity-75"}>
      <div className={"bg-gray-500 text-yellow-500 w-auto pt-6"}>
        <div
          className={
            "flex justify-content-between align-items-center text-yellow-500"
          }
        >
          <div className={"text-3xl pl-6"}>FAVORITES</div>
